# This file will look for new folder inside user uploads and convert them into reel if they are not already converted
    ...
    while True:
        ...
        for folder in folders:
            if(folder not in done_folders):
                ...
                create_reel(folder) # this will convert the images and audio inside the folder to a reel
